...
calculator = Tk()
calculator.title("KALKULATORKU")
calculator.resizable(0, 1)#konfigurasi untuk mendapatkan ukuran layar yang berbeda
...
class Application(Frame):
	...
	def calculateExpression(self):#fungsi kalkulator && massage box
		...
		try:
			...
			messagebox.showinfo("ERROR", "Input Anda Salah", icon="warning", parent=calculator)

	def clearText(self):#Menghapus input saat menekan "C" pada kalkulator
		self.replaceText("0")
